...
<template>
    <vx-card title="Miscellaneous" code-toggler>
        <p>
            You can add a
            <strong>filtered, sorted, paginated and multi selected</strong>
            table with combination of the <code>search</code>,
            <code>multiple</code> and <code>pagination</code> properties for
            example
        </p>
        <br />
